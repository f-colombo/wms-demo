                ...
                <div className=" bg-gray-100 ">
                    <div className="container p-10 mx-auto">
                        ...
                        <div>
                            ...
                            <p className="text-5xl font-semibold mb-6"><NumberFormat  value={dashboardItems.valorInventario.utilidad} displayType={'text'} thousandSeparator={true} prefix={'$'} /></p>
                            <div className="grid grid-cols-2 bg-white mb-6 border-2 p-6 rounded-md">
                                <div className="flex flex-col items-center">
                                    ...
                                    <p className="text-5xl font-semibold text-green-500"><NumberFormat  value={dashboardItems.valorInventario.precioVenta} displayType={'text'} thousandSeparator={true} prefix={'$'} /></p>
                                </div>
                                <div className="flex flex-col items-center">
                                    <p className="text-lg font-semibold">Costo Compra:</p>
                                    <p className="text-5xl font-semibold text-red-500"><NumberFormat  value={dashboardItems.valorInventario.costoCompra} displayType={'text'} thousandSeparator={true} prefix={'$'} /></p>
                                </div>
                            </div>
                        </div>
                    </div>
