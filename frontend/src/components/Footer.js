            ...
            <footer className="text-center lg:text-left bg-gray-100 text-gray-600">
                <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
                    <div className="mr-12 hidden lg:block">
                        <span>Software diseñado y creado para optimizar los procesos de almacenamiento, distribución, cadena de suministro y cumplimiento dentro de una empresa de distribución de medicinas.</span>
                    </div>
                ...
                <div className="text-center p-6 bg-gray-200">
                    ...
                    <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/">Freddy Colombo</a>
                </div>
            </footer>
        </>
    );
